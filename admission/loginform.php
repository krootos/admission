<div class="col-md-12 mb-3">
    ...
    <form class="form-horizontal" method="post" action="index.php" name="formlogin">
        ...
        <div class="form-group form-group-lg">
            ...
            <div class="col-sm-12">
                <input name="txtPwd" class="form-control input-lg" id="inputPassword3" type="password" required="" placeholder="เลขประจำตัวประชาชน 13 หลัก" type="text" maxlength="13" onkeyup="javascript:remainLength();">
                </input>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-sm-offset-1 col-sm-11 text-center">
                ...
                <a href="index.php?re=register" name="regis" class="btn btn-info btn-lg">
                    ลงทะเบียน
                </a>
            </div>
        </div>
