            ...
            <div class="menu-area">
                ...
                <nav class="full-width-part">
                    <ul class="no-bullets">
                        ...
                        <a href="#">
                            <li> <button type="button" class="menu__item" data-target="tnw-sub-menu-275" aria-expanded="false" aria-controls="ku-sub-menu-275">
                                    ระเบียบการรับสมัคร
                                </button>
                            </li>
                        </a>
                    ...
                    <div class="header-dropdown__wrap">
                        ...
                        <div class="header-dropdown-menu" id="tnw-sub-menu-275" data-sub="tnw-sub-menu-275">
                            <div class="header-dropdown-menu__content col-9">
                                ...
                                <ul>
                                    <li><a href="#">ระเบียบการรับสมัครห้องเรียนพิเศษวิทยาศาสตร์ คณิตศาสตร์ วิทยาศาสตร์ เทคโนโลยี และสิ่งแวดล้อม (SMSTE) ม.4</a>
                                        <ul class="sub_3" style="margin-left: 20px;">
                                ...
                                <ul>
                                    <li><a href="#">ระเบียบการรับสมัครห้องเรียนพิเศษภาษาอังกฤษ( English Program (EP) ) ม.1, ม.4</a>
                                        <ul class="sub_3" style="margin-left: 20px;">
                                            <li>
