<div class="footer-section">
    ...
    <div class="subscription-n-home-links">
        ...
        <div class="content-wrapper">
            ...
            <!-- subscription -->
            <a href="https://feed.tnw.in.th/" class="news-letter" target="_blank">
                <div class="m-3">
            ...
            <div class="home-links">
                ...
                <a href="https://www.facebook.com/ScTNW" target="_blank" class="home-link newcomer-link ku-check-webp webp">
                ...
                <a href="https://www.facebook.com/eptnw.sakon" target="_blank" class="home-link partner-link ku-check-webp webp">
                    <div class="bg-wrapper">
                        <div></div>
                    </div>
                    <div class="text-link">
        ...
        <div class="content-wrapper d-flex">
            ...
            <div class="link-content text-white mr-2">
                ...
                <div class="ku-license">
                    สงวนลิขสิทธิ์ © 2565 งานรับสมัครนักเรียนกลุ่มบริหารวิชาการ โรงเรียนธาตุนารายณ์วิทยา </div>

                <!-- Usage Plicy -->
                <ul class="web-usage-policy no-bullets d-flex justify-content-center pl-0 mb-0">
                    <li class="ml-3 mr-3">
                        <a href="https://thaivantour.com/">thaivantour.com</a>
                    </li>
                    <li class="ml-3 mr-3"><a href="https://vanopenclub.com">vaopenclub.com</a></li>
                    <li class="ml-3 mr-3"><a href="https://เช่ารถตู้สกลนคร.com">เช่ารถตู้สกลนคร</a></li>
...
<script src="https://www.ku.ac.th/assets/js/vendor/modernizr-webp.js" type="text/javascript" defer></script>
<script>
    (function() {
    ...
    function setKuFZ() {
        if (localStorage.getItem("ku-fz")) {
            ...
            $('.set-ku-fz').removeClass('active');
            $('.set-ku-fz [name=]').addClass('active');
            $('html').removeClass('ku-fz-sm ku-fz-md ku-fz-lg');
